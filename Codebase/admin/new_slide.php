...
// if everything is ok, try to upload file
        ...
        if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $target_file)) {
            ...
            $r=$conn->query($sql);
            if($r){
                $msg= "Slide Saved Successfully<br>";
                $err=false;
            }
            else{
                $errmsg.= "Sorry, there was an error while saving slide.<br>";
            }
        } else {
...
?>
    <div class="page-header">
        ...
        <h1>Slider <small>Control the data on slider</small></h1>
    </div>
            ...
            <div class="block">
                ...
                <form id="validate" method="POST" enctype="multipart/form-data">
                    <div class="data-fluid">
                        ...
                        <div class="row-form">
                            <div class="span2">Slide Number</div>
                            <div class="span2">
                        ...
                        <div class="toolbar bottom tar">
                            <div class="btn-group">
                                <button class="btn" type="submit" name="save">Save Slide</button>
                            </div>
                        </div>
